...
var (
	validPattern   = "sqco_FbT1v5HrMX6qyKUkaoLQdYOniAVhbEccERraQABuhBayDOkyCZTa8TDQFRp"
	invalidPattern = "sqco_FbT1v5HrMX6qyKUkaoLQdYOniAVhbEccERraQABuhBayDOkyCZTa8TDQF=="
)
...
func TestSonarCloud_Pattern(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input: fmt.Sprintf("token = '%s'", invalidPattern),
			want:  []string{},
		},
	}
